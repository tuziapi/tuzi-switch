...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            product_installer::switch_claudecode_variant,
            product_installer::upgrade_claudecode,
            product_installer::get_codex_status,
            product_installer::install_codex,
            product_installer::switch_codex_variant,
            product_installer::upgrade_codex,
            product_installer::get_gemini_status,
            product_installer::install_gemini,
            product_installer::switch_gemini_variant,
            product_installer::upgrade_gemini,
            ...
            commands::get_tuzi_workspace_summary,
            commands::get_tuzi_workspace_trends,
            commands::get_tuzi_workspace_distribution,
