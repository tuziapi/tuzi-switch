...
//!
//! Parses tuziswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a tuziswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// tuziswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != crate::product::DEEP_LINK_SCHEME {
